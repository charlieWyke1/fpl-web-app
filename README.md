...
I did all the codebase (front and back end) by myself without the help of AI, but when uploading and learning hwo to use Github, I made the most of AI models and the github ahgents to help me learn what I was doing with GitHub as it is quite a daunting task at the start. The three most recently editied files are all craeted with the help of VSCode agent to help me learn how to upload the project safely and as a code peice show off.
